...
void HAL_GD_ReadCurrents(HAL_MEASURE_CURRENT_T *pCurrent)
{
       ...
       /* For DRV8316 - LP MSPMG3519 combination
        *  Iu - ADC 1 - Mem0 - Ch - 13
        *  Iv - ADC 1 - Mem1 - Ch - 14
        *  Iv - ADC 0 - Mem0 - Ch - 12
        *  Iw - ADC 0 - Mem1 - Ch - 2
...
void HAL_GD_ConfigureCurrentChannels(CURRENT_SHUNT_TYPES currentShunt)
{
    ...
    switch(currentShunt)
    {
          ...
          case CURRENT_THREE_SHUNT_AB_C:
              ...
              HAL_setADCIdxChannel(FOC_CURR_ADC0_INST, ADC0_IDX_0, ADC0_CURRENT_W_CH);
              break;
          case CURRENT_THREE_SHUNT_A_BC:
              HAL_setADCIdxChannel(FOC_CURR_ADC1_INST, ADC1_IDX_0, ADC1_CURRENT_U_CH);
              HAL_setADCIdxChannel(FOC_CURR_ADC0_INST, ADC0_IDX_0, ADC0_CURRENT_V_CH);
              HAL_setADCIdxChannel(FOC_CURR_ADC0_INST, ADC0_IDX_1, ADC0_CURRENT_W_CH);
              break;
