...
void update_MotorStartUp2Config(USER_INPUTS_T *pUserInputs)
{
    ...
    temp = pUserInputRegs->mtrStartUp2.b.olMaxSpeed;
    if(temp <=19 )
    {
...
void update_SystemParams(USER_INPUTS_T *pUserInputs)
{
    ...
    pUserInputs->hallSectorPerRev  = pUserInputRegs->systemParams.polePairs * (MAX_HALL_INDEX-1);
}
...
void update_FaultCfg2Config(USER_INPUTS_T *pUserInputs)
{
    ...
    pUserInputs->moduleFlags.b.abnormalSpeedStallDetectEnable =
            pUserInputRegs->faultCfg2.b.abnormalSpeedEn;
    pUserInputs->moduleFlags.b.noMotorStallDetectEnable =
            pUserInputRegs->faultCfg2.b.noMotorEn;
    pUserInputs->moduleFlags.b.hallInvalidStallDetectFault =
            pUserInputRegs->faultCfg2.b.hallInvalidStall;
