...
#ifndef SERVICESHAL_H
#define SERVICESHAL_H
...
/**
 * @brief     Sets deadtime
 * @param[in] value  Value for Deadtime configuration
 */
void HAL_setDeadTime(uint32_t value);

/**
 * @brief     Gets minimum on time for sine modulation
 * @return    Returns the minimum on time in ns
 */
int32_t gateDriverGetMinOTimeSineMod(void);

/**
 * @brief     Gets minimum on time for over modulation
 * @return    Returns the minimum on time in ns
 */
int32_t gateDriverGetMinOnTimeOverMod(void);

/**
 * @brief     Gets the gate driver propagation delay
 * @return    Returns the gate driver propagation delay
 */
