...
{
    /*! Open Loop ramp up */
    OPEN_LOOP_ACCELERATING_PROFILE = 0,     /* Accelerate user on profile */
...
typedef struct
{
    ...
    int32_t
    /*! starting Speed reference */
        initialSpeedReference,
        /*! Velocity Reference */
        velocityReference,
        ...
        loopExecutionCount,
        /*! Initial value for close loop to open loop transition */
        loopExecutionCountInit,
        ...
        iqRefSetFastAccel,
        /*! Q-axis current reference to support speed reversal in open loop */
        iqRefSetSpeedReversal,
        /*! Maximum Forward speed reference - user */
        speedReferenceMaxForwardSet,
        /*! Maximum Reverse speed reference - user */
        speedReferenceMaxReverseSet,
    ...
    /*! Slew rate for speed reference */
        ...
        *pAccelRefSlewRate,
        ...
        /*! Speed reference slew rate rev drive */
        speedRefSlewRateDecel,
        /*! Acceleration slew rate reverse drive */
        accelRefSlewRateDecel;
