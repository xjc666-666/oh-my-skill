 ...
 * --/COPYRIGHT--*/
/*!****************************************************************************
 *  @file       deadTimeCompute.h
 *  @brief      Dead Time Computation Module
 *
 *
 *  @anchor deadTimeCompute_h
 *  # Overview
 *
 ...
 *  <hr>
 ******************************************************************************/
#ifndef ALGOLIB_LIBRARIES_INCLUDE_DEADTIMECOMPUTE_H_
#define ALGOLIB_LIBRARIES_INCLUDE_DEADTIMECOMPUTE_H_

#include "stdint.h"
#include "mcLib.h"

/*! @brief Dead Time COMP Freq Lim */
#define DEAD_TIME_COMP_MAX_FREQ_HZ      80.0

/*! @brief Dead Time Comp flags Structure */
typedef union
{
    /*! @brief Dead Time Comp  */
    struct deadTimeCompFlags
    {
        _Bool
        /*! Enables Dead-time compensation */
            enable: 1,
            /*! Dead-time compensation enable set by user */
            enableSet: 1;
    }
    /*! Bitwise access */
    b;
...
}DEAD_TIME_COMP_FLAGS_T;

/*! @brief Dead Time Comp Working Structure */
typedef struct
{
     const int32_t
     /*!Speed set by user */
     ...
     DEAD_TIME_COMP_FLAGS_T
     /*! Dead-time compensation Flags */
         flags;
}DEAD_TIME_COMPUTE_T;

/*! @brief Dead Time Comp Variable */
extern DEAD_TIME_COMPUTE_T deadTimeComp;
/**
 * @brief    Dead Time Compute  Init
 * @param[in] * Input Pointer
 */
void deadTimeComputeReInit(DEAD_TIME_COMPUTE_T *);
/**
 * @brief      Dead Time Compute Re Init
 * @param[in] * Input Pointer
 */
void deadTimeComputeInit(DEAD_TIME_COMPUTE_T *);
/**
 * @brief      Dead Time Compute Run
 * @param[in] * Input Pointer
 */
void deadTimeComputeRun(DEAD_TIME_COMPUTE_T *);
/**
 * @brief     Dead Time Compute Low Priority Run
 * @param[in] * Input Pointer
 */
void deadTimeComputeLowPriorityRun(DEAD_TIME_COMPUTE_T *);

#endif /* ALGOLIB_LIBRARIES_INCLUDE_DEADTIMECOMPUTE_H_ */
