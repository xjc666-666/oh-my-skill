...
void hallAngleEstimRun(HALL_ESTIMATOR_OBJ_T *pHallHandle)
{
    ...
    if(pHallHandle->hallIndex != pHallHandle->hallIndexPrev)
    {
        ...
        hallPhaseError = getHallPhaseError(pHallHandle->pHALLIntHandle, 
                                    pHallHandle->hallEstimVelocity);

        pHallHandle->hallEstimFluxAngle += hallPhaseError;
