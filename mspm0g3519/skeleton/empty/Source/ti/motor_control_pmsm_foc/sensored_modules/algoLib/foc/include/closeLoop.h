...
typedef union
{
    ...
    struct closeLoopFlags
    {
        _Bool
            ...
            avsEnable: 1,
            /*! Filters the Hall generated Angle */
            hallFilterEn: 1;
...
typedef struct
{
    ...
    /*! Maximum Phase Current Peak Reference*/
        ...
        * open loop angle and estimator angle */
        angleOffset,
        ...
        modIndexSqr,
        /*! Modulation Index Squared Limit
         * for active brake */
        modIndexSqrLimit,
        /*! Scaling for target reference in
        torque control mode*/
    ...
    MC_SINCOS_T
    /*! Sin,Cos of Lead angle used in
    modulation index control mode*/
        mdqForceSinCos;
...
inline _Bool getAvsStatus(CLOSE_LOOP_T *pCloseLoop)
{
    ...
    return (pCloseLoop->flags.b.avsEnable &&
