...
int32_t getHallFrequency(HAL_MEASURE_HALL_HANDLE_T *pHallHandle)
{
    ...
    pHallHandle->countDiff = (pHallHandle->commCountIndex[pHallHandle->compHallState] > pHallHandle->commCountIndex[pHallHandle->hallState])?
            ...
            (HAL_getTimerLoadValue(pHallHandle->HallInterface.captureInput) + (pHallHandle->commCountIndex[pHallHandle->compHallState] - pHallHandle->commCountIndex[pHallHandle->hallState]) + 1);
    ...
    pHallHandle->countError = (pHallHandle->commCountIndex[pHallHandle->hallState] > pHallHandle->commTimerIndex[pHallHandle->hallState])?
            ...
            (HAL_getTimerLoadValue(pHallHandle->HallInterface.captureInput) + (pHallHandle->commCountIndex[pHallHandle->hallState] - pHallHandle->commTimerIndex[pHallHandle->hallState]) + 1);
...
int32_t getHallPhaseError(HAL_MEASURE_HALL_HANDLE_T *pHallHandle, int32_t hallEstimVelocity)
{
    ...
    pHallHandle->halPhaseError =  pHallHandle->halPhaseErrorConst * pHallHandle->countError;
    pHallHandle->halPhaseError = _IQmpy_mathacl(pHallHandle->halPhaseError, hallEstimVelocity);
    return pHallHandle->halPhaseError; 
}